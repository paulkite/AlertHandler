//
//  V77AlertHandlerUITests.swift
//  V77AlertHandlerUITests
//
...
class V77AlertHandlerUITests: XCTestCase {
    ...
    func testAlert() {
        ...
        app.alerts["Title"].collectionViews.buttons["S_Cancel"].tap()
    }
    ...
    func testActionSheet() {
        ...
        app.sheets["Title"].buttons["S_Cancel"].tap()
    }
